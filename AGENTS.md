...
> **Note:** For repository-specific knowledge (architecture, domain rules, API details), see [SKILL.md](./SKILL.md).
...
- **Don't reinvent the wheel** — search for existing solutions first: reread documentation, check GitHub issues (open *and* closed), study original code
...
- Use language-specific type features to model domain constraints (e.g., Rust enums, TS `zod` schemas, Python `dataclass`)
